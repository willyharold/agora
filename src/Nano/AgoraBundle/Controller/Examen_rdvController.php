...
class Examen_rdvController extends Controller
{
     ...
     *
     * @Route("/{id}/edit", name="examen_rdv_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}", name="examen_rdv_delete")
     * @Method("DELETE")
     */
