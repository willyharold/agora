...
use Nano\AgoraBundle\Entity\Message;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $messages = $em->getRepository('NanoAgoraBundle:Message')->findAll();
    ...
    {
        $message = new Message();
        $form = $this->createForm('Nano\AgoraBundle\Form\MessageType', $message);
    ...
    {
        $deleteForm = $this->createDeleteForm($message);
        $editForm = $this->createForm('Nano\AgoraBundle\Form\MessageType', $message);
